...
detekt {
    toolVersion = com.smile.mvvmtemplate.buildsrc.Depends.Versions.detektVersion
...
dependencies {
    detektPlugins(com.smile.mvvmtemplate.buildsrc.Depends.ClassPaths.detekt_gradle_plugin)
}
